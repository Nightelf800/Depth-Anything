...
order = "--encoder vits --dataset nyudepthv2 --img-path F:/Datasets/NYUv2 --outdir .\/res --crop_h 450 --crop_w 450"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='nyu', choices=['nyu', 'kitti', 'imagepath'])
    ...
    depth_anything = DepthAnything.from_pretrained('./checkpoints/depth_anything_vitb14', local_files_only=True).to(
        DEVICE).eval()
