...
from VFDepth.external.dataset import get_transforms
...
def construct_dataset(cfg, mode, **kwargs):
    ...
    if cfg['data']['dataset'] == 'ddad':
        from VFDepth.dataset.ddad_dataset_sf import DDADdatasetSF
    ...
    # NuScenes dataset         
        ...
        from VFDepth.dataset.nuscenes_dataset import NuScenesdataset
