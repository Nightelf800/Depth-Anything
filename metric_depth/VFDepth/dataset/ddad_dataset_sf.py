...
from VFDepth.external.utils import Camera, generate_depth_map, make_list
from VFDepth.external.dataset import DGPDataset, SynchronizedSceneDataset, stack_sample
...
class DDADdatasetSF(DGPDataset):
    ...
    def __init__(self, *args, with_mask, scale_range, **kwargs):
        ...
        print(f"depth_type: {self.depth_type}")
    ...
    def __getitem__(self, idx):
        ...
        # print(f"dataloader.data.keys: ", data.keys())
        ...
        # print(f"stack.data.keys: ", sample.keys())
        sample = align_dataset(sample, self.scales, contexts)
        # print(f"align.data.keys: ", sample.keys())
